...
| `task-106` | `ms-03` | Define user-visible progress reporting and agile issue/discussion flow | Edward + AI | 3 | 14 | `done` | User-visible progress and GitHub issue/discussion operating rules are now documented in the governance files. |
...
| `task-110` | `ms-01` | Define timestamp-based versioning standard | Edward + AI | 2 | 10 | `done` | GitHub issue: #3. The canonical format is documented and emitted by the release metadata workflow. |
| `task-111` | `ms-02` | Create CI pipelines for testing, validation, and release flows | Edward + AI | 5 | 24 | `done` | GitHub issue: #2. Test CI exists and release metadata automation now exists for the current scope. |
